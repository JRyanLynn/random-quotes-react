      ...
      <div className="App container-fluid">
        <wrapper
          ...
          <div id="quote-container" className="col-6 box p-5 rounded">
            <div id="text" className="text-center display-2">
              {" "}
              "{this.state.quote}"
            </div>
            ...
            <div className=" buttons d-flex justify-content-between">
              <a id="tweet-quote" className="btn btn-secondary active" role="button" aria-pressed="true" href="https://twitter.com/intent/tweet?hashtags=quotes&related=freecodecamp&text="
              >
                #tweet
              </a>
